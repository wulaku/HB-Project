      ...
      <div class="sidebar-left-content nano-content">
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
                 <?= Html::a('查看文章', ['site/index'], ['class' => 'glyphicon glyphicon-equalizer']) ?>
              </li>
              <li>
                 <?= Html::a('增加文章', ['site/acreate'], ['class' => 'glyphicon glyphicon-calendar']) ?>
              </li>
            </ul>
            </li>
...
<h1><?= Html::encode($this->title) ?></h1>
    ...
    <p>
        <?= Html::a('Create  New Hb Banned', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
