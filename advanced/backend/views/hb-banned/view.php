        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              ...
              <li>
                 <?= Html::a('黑名单列表', ['index'], ['class' => 'fa fa-money']) ?>
              </li>
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              ...
              <li>
                <?= Html::a('增加文章', ['site/acreate'], ['class' => 'glyphicon glyphicon-equalizer']) ?>
              </li>
            </ul>
            </li>
...
<div class="wrap">
 ...
 <div class="hb-banned-view">
    ...
    <p>
        <?= Html::a('修改', ['update', 'id' => $model->banid], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('删除', ['delete', 'id' => $model->banid], [
        ...
        <?= Html::a('返回', ['index', 'id' => $model->banid], ['class' => 'btn btn-success']) ?>
    </p>
