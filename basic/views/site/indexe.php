...
<form role="search" method="get" class="search-form" action="http://localhost:8080/wordpress/">
	<label for="search-form-596cb8e45cc21">
		<span class="screen-reader-text">搜索：</span>
	</label>
	<input type="search" id="search-form-596cb8e45cc21" class="search-field" placeholder="搜索…" value="" name="s" />
	<button type="submit" class="search-submit"><svg class="icon icon-search" aria-hidden="true" role="img"> <use href="#icon-search" xlink:href="#icon-search"></use> </svg><span class="screen-reader-text">搜索</span></button>
					...
					<li>
				<a href="http://localhost:8080/wordpress/2017/07/17/my-first-article/">my first article</a>
						</li>
					<li>
				<a href="http://localhost:8080/wordpress/2017/07/11/hello-world/">世界，您好！</a>
						</li>
				</ul>
		</section>		<section id="recent-comments-2" class="widget widget_recent_comments"><h2 class="widget-title">近期评论</h2><ul id="recentcomments"><li class="recentcomments"><span class="comment-author-link"><a href='https://wordpress.org/' rel='external nofollow' class='url'>一位WordPress评论者</a></span>发表在《<a href="http://localhost:8080/wordpress/2017/07/11/hello-world/#comment-1">世界，您好！</a>》</li></ul></section><section id="archives-2" class="widget widget_archive"><h2 class="widget-title">文章归档</h2>		<ul>
			<li><a href='http://localhost:8080/wordpress/2017/07/'>2017年七月</a></li>
		</ul>
		</section><section id="categories-2" class="widget widget_categories"><h2 class="widget-title">分类目录</h2>		<ul>
	<li class="cat-item cat-item-1"><a href="http://localhost:8080/wordpress/category/uncategorized/" >未分类</a>
</li>
		</ul>
</section><section id="meta-2" class="widget widget_meta"><h2 class="widget-title">功能</h2>			<ul>
			<li><a href="http://localhost:8080/wordpress/wp-admin/">管理站点</a></li>			<li><a href="http://localhost:8080/wordpress/wp-login.php?action=logout&#038;_wpnonce=daa7b7bb4a">登出</a></li>
			<li><a href="http://localhost:8080/wordpress/feed/">文章<abbr title="Really Simple Syndication">RSS</abbr></a></li>
			<li><a href="http://localhost:8080/wordpress/comments/feed/">评论<abbr title="Really Simple Syndication">RSS</abbr></a></li>
